        ...
        <div class="panel panel-default wow bounceInUp" data-wow-delay="0.4s">
          <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Bootstrap Examples</h4></div>
              ...
              <div class="list-group">
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Modal / Dialog</a>
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Datetime Examples</a>
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Data Grids</a>
              </div>
            </div>
   		</div>
...
Bootply. All of these templates are free and don't require extensive 
customization to the Bootstrap baseline.
              <hr>
              <ul class="list-unstyled"><li><a href="http://usebootstrap.com/theme/google-plus">Dashboard</a></li><li><a href="http://usebootstrap.com/theme/google-plus">Darkside</a></li><li><a href="http://usebootstrap.com/theme/google-plus">Greenfield</a></li></ul>
            </div>
         </div> 
...
real-time from your Web browser. Bootply combines the power of 
hand-coded HTML, CSS and JavaScript with the benefits of responsive 
design using Bootstrap. Find and showcase Bootstrap-ready snippets in 
  	...
  	<div class="col-sm-6 col-md-4">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Top Items</h4></div>
   			<div class="panel-body">
              <div class="list-group">
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item active">Bootstrap 3</a>
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Snippets</a>
                <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Examples</a>
              </div>
            </div>
   		</div>
    ...
    <div class="col-sm-6 col-md-4">
    	<div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Upgrade to Bootstrap 3</h4></div>
              ...
              Bootstrap 3 is a major overhaul, and there are a lot of changes from Bootstrap 2.x. <a href="http://bootply.com/bootstrap-3-migration-guide" rel="nofollow">This guidance</a> is intended to help 2.x developers transition to 3.
              </p>
              <h5><a href="http://usebootstrap.com/theme/google-plus">More on Upgrading from +Bootply</a></h5>
              ...
              <div class="well well-sm">
                <div class="media">
                    <a class="thumbnail pull-left" href="#">
                        <img class="media-object" src="resources/img/a13ac7aed64918b6354f48da59490e3a.jpg">
                    </a>
     ...
     <div class="col-sm-6 col-md-4">
    	<div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Inspiration</h4></div>
              ...
              <p>The more powerful (and 100% fluid) Bootstrap 3 grid now
 comes in 4 sizes (or "breakpoints"). Tiny (for smartphones), Small (for
 tablets), Medium (for laptops) and Large (for laptops/desktops).</p>
              <div class="clearfix"></div>
              <hr>
              <div class="clearfix"></div>
              <img src="resources/img/FFF_004.gif" class="img-responsive img-thumbnail pull-left" style="margin-right:5px;">
              <p>Mobile first" is a responsive Web design practice that 
prioritizes consideration of smart phones and mobile devices when 
creating Web pages.</p>
	...
	<div class="row">
	   ...
	   <div class="col-sm-4 col-xs-6">
        ...
        <div class="panel panel-default">
          <div class="panel-thumbnail"><img src="resources/img/bg_suburb.jpg" class="img-responsive"></div>
          <div class="panel-body">
            <p class="lead">Hacker News</p>
            <p>120k Followers, 900 Posts</p>
            
            <p>
              <img src="resources/img/photo_003.jpg" height="28px" width="28px">
      ...
      <div class="col-sm-4 col-xs-6">
      	...
      	<div class="panel panel-default">
          <div class="panel-thumbnail"><img src="resources/img/FFF.gif" class="img-responsive"></div>
          <div class="panel-body">
      ...
      <div class="col-sm-4 col-xs-6">
      	...
      	<div class="panel panel-default">
          <div class="panel-thumbnail"><img src="resources/img/FFF_002.gif" class="img-responsive"></div>
          <div class="panel-body">
...
<div style="display: none;" id="loginModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header">
          ...
          <h2 class="text-center"><img src="resources/img/photo_002.png" class="img-circle"><br>Login</h2>
      </div>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="col-md-12 text-center">
            <a href="http://usebootstrap.com/theme/google-plus">This Bootstrap Template</a><br>was made with <i class="glyphicon glyphicon-heart"></i> by <a href="http://usebootstrap.com/theme/google-plus">Bootply</a>
            <br><br>
