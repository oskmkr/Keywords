	...
	<div class="navbar navbar-default" id="subnav">
		<div class="col-md-12">
			<div class="navbar-header">
				...
				<a href="#" style="margin-left: 15px;" class="navbar-btn btn btn-default btn-plus dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-home" style="color: #dd1111;"></i> Home <small><i
	...
	<div class="container" id="main">
				...
				<div class="panel panel-default wow bounceInUp" data-wow-delay="0.4s">
					...
					<div class="panel-body">
						<div class="list-group">
							<a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Modal / Dialog</a> <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Datetime Examples</a> <a
								href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Data Grids</a>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="clearfix"></div>
						<hr>
						Design, build, test, and prototype using Bootstrap in real-time from your Web browser. Bootply combines the power of hand-coded HTML, CSS and JavaScript with the benefits of responsive design using Bootstrap. Find and showcase
						...
						<div class="well well-sm">
							<div class="media">
								...
								<div class="media-body">
									...
									<p>
										<a href="#" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-comment"></span> Message</a> <a href="#" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-heart"></span> Favorite</a>
									</p>
								</div>
							</div>
						</div>
		...
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<p>
					<a href="http://usebootstrap.com/theme/google-plus" target="_ext">Download Google Plus Style Template</a><br>
					<a href="http://usebootstrap.com/theme/google-plus" target="_ext">More Bootstrap Templates by @Bootply</a>
				</p>
			</div>
			<hr>
	...
	<div style="display: none;" id="aboutModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="col-md-12 text-center">
						<a href="http://usebootstrap.com/theme/google-plus">This Bootstrap Template</a><br>was made with <i class="glyphicon glyphicon-heart"></i> by <a href="http://usebootstrap.com/theme/google-plus">Bootply</a> <br>
						<br> <a href="https://github.com/iatek/bootstrap-google-plus">GitHub Fork</a>
					</div>
				</div>
				<div class="modal-footer">
