	...
	<div class="container" id="main">
		<div class="row">
			...
			<%--
				<div class="panel panel-default wow tada" data-wow-delay="0.4s">
					...
					<div class="panel-body">
						<div class="list-group">
							<a href="http://usebootstrap.com/theme/google-plus" class="list-group-item wow bounceInUp" data-wow-delay="0.4s">Modal / Dialog</a> 
							<a href="http://usebootstrap.com/theme/google-plus" class="list-group-item wow bounceInUp" data-wow-delay="1.4s">Datetime Examples</a>
							<a href="http://usebootstrap.com/theme/google-plus" class="list-group-item wow bounceInUp" data-wow-delay="2.4s">Data Grids</a>
						</div>
					</div>
				</div>
				
				<div class="panel panel-default wow bounce" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow flash" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow pulse" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow shake" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow swing" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow wobble" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceIn" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceInDown" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceInLeft" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceInRight" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceOut" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">View all</a>
						<h4>Bootstrap Examples</h4>
					</div>
				...
				<div class="panel panel-default wow bounceOutDown" data-wow-delay="0.4s">
					<div class="panel-heading">
						<a href="#" class="pull-right">Run</a>
						<h4>Bootstrap Examples</h4>
					</div>
				</div>
				...
				<div class="well wow bounce">
					<form class="form-horizontal" role="form">
						...
						<ul class="list-inline">
							<li><a href="#"><i class="glyphicon glyphicon-align-left"></i></a></li>
							<li><a href="#"><i class="glyphicon glyphicon-align-center"></i></a></li>
							<li><a href="#"><i class="glyphicon glyphicon-align-right"></i></a></li>
						</ul>
					</form>
				</div>
 ...
 --%>
			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="well">
					<form class="form">
						...
						<div class="input-group text-center">
							<input class="form-control input-lg" placeholder="Enter your email address" type="text"> <span class="input-group-btn"><button class="btn btn-lg btn-primary" type="button">OK</button></span>
						</div>
					</form>
				</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<p>
							<img src="resources/img/150x150.gif" class="img-circle pull-right"> <a href="#">The Bootstrap Playground</a>
						</p>
						<div class="clearfix"></div>
						<hr>
						Design, build, test, and prototype using Bootstrap in real-time from your Web browser. Bootply combines the power of hand-coded HTML, CSS and JavaScript with the benefits of responsive design
						using Bootstrap. Find and showcase Bootstrap-ready snippets in the 100% free Bootply.com code repository.
					</div>
				</div>
			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<p>
							...
							tag at <a href="http://stackoverflow.com/questions/tagged/twitter-bootstrap">Stackoverflow</a> is a good place to find answers.
						</p>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="list-group">
							<a href="http://usebootstrap.com/theme/google-plus" class="list-group-item active">Bootstrap 3</a> <a href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Snippets</a> <a
								href="http://usebootstrap.com/theme/google-plus" class="list-group-item">Examples</a>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="well well-sm">
							<div class="media">
								<a class="thumbnail pull-left" href="#"> <img class="media-object" src="resources/img/a13ac7aed64918b6354f48da59490e3a.jpg">
								</a>
								<div class="media-body">
									<h4 class="media-heading">Jose Kinsella</h4>
									<p>
										<span class="label label-info">10 photos</span> <span class="label label-primary">89 followers</span>
									</p>
									<p>
										<a href="#" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-comment"></span> Message</a> <a href="#" class="btn btn-xs btn-default"><span
			...
			<div class="col-sm-6 col-md-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<p>The more powerful (and 100% fluid) Bootstrap 3 grid now comes in 4 sizes (or "breakpoints"). Tiny (for smartphones), Small (for tablets), Medium (for laptops) and Large (for
							laptops/desktops).</p>
						<div class="clearfix"></div>
						<hr>
						<div class="clearfix"></div>
		...
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<p>
					<a href="http://usebootstrap.com/theme/google-plus" target="_ext">Download Google Plus Style Template</a><br> <a href="http://usebootstrap.com/theme/google-plus" target="_ext">More
						Bootstrap Templates by @Bootply</a>
				</p>
			</div>
			<hr>
	...
	<div style="display: none;" id="aboutModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="col-md-12 text-center">
						<a href="http://usebootstrap.com/theme/google-plus">This Bootstrap Template</a><br>was made with <i class="glyphicon glyphicon-heart"></i> by <a
							href="http://usebootstrap.com/theme/google-plus">Bootply</a> <br> <br> <a href="https://github.com/iatek/bootstrap-google-plus">GitHub Fork</a>
					</div>
				</div>
				<div class="modal-footer">
